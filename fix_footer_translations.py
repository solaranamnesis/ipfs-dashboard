...
FULL_REPLACE_LOCALES = ['af', 'am', 'az', 'bg', 'bs', 'ca', 'cy', 'da', 'eo', 'fi', 'ga', 'gu', 'ha', 'hr', 'ht', 'ia', 'ig', 'ka', 'kk', 'kn', 'ku', 'la', 'lb', 'ml', 'mn', 'mr', 'mg', 'ms', 'my', 'no', 'ps', 'qu', 'ro', 'so', 'sr', 'te', 'tl', 'uk', 'yo', 'zu']
...
def build_translations(ns):
    ...
    t['ml'] = {
        ...
        'da': 'ഡാനിഷ്',
        'no': 'നോർവീജിയൻ',
        'az': f'അസർബൈജാനി ({ns["az"]})',
        'mg': 'മലഗാസി',
        'qu': 'കെച്ച്വ (Runa Simi)',
        'ga': 'ഐറിഷ്',
        'cy': 'വെൽഷ്',
        'eo': 'എസ്പെരാന്റോ',
        'ia': 'ഇന്റർലിംഗ്വാ',
    ...
    t['ms'] = {
        ...
        'tr': f'Turki ({ns["tr"]})',
        'hu': 'Hungary',
        'new': f'Bahasa Nepal Bhasa ({ns["new"]})',
    ...
    t['ia'] = {
        ...
        'bs': 'Bosniace',
        'hr': 'Croate',
        'uk': f'Ukrainese ({ns["uk"]})',
        'zh': f'Sinese ({ns["zh"]})',
        'he': f'Hebreic ({ns["he"]})',
        'th': f'Tai ({ns["th"]})',
        'vi': f'Vietnamesec ({ns["vi"]})',
        'ar': f'Arabe ({ns["ar"]})',
        'hi': f'Hindi ({ns["hi"]})',
        'el': f'Grec ({ns["el"]})',
        'eo': 'Esperanto',
    ...
    t['hy'] = {
        ...
        'ka': f'\u054e\u0580\u0561\u057d\u057f\u0565\u0580\u0565\u0576 ({ns["ka"]})',
        'lb': 'Lëtzebuergesch',  # Vrastérén
    ...
    t['bg'] = {
        ...
        'bg': 'Български',
        'my': f'Бирмански ({ns["my"]})',
        'so': 'Сомалийски',
        'zu': 'Зулуски',
        'da': 'Датски',
        'no': 'Норвежки',
        'az': f'Азербайджански ({ns["az"]})',
        'mg': 'Малагасийски',
        'qu': 'Кечуа (Runa Simi)',
        'ga': 'Ирландски',
        'cy': 'Уелски',
    ...
    t['lb'] = {
        ...
        'de': 'Däitsch',
        'fr': 'Franséisch',
        'ja': f'Japanesch ({ns["ja"]})',
        'it': 'Italienesch',
        'ru': f'Russesch ({ns["ru"]})',
        'sr': f'Serbesch ({ns["sr"]})',
        'bs': 'Bosnesch',
        'hr': 'Kroatesch',
        'uk': f'Ukrainesch ({ns["uk"]})',
        'zh': f'Chinesesch ({ns["zh"]})',
        'he': f'Hebräesch ({ns["he"]})',
        'th': f'Thäilänesch ({ns["th"]})',
        'vi': f'Vietnamesech ({ns["vi"]})',
        'ar': f'Arabesch ({ns["ar"]})',
        'hi': f'Hindi ({ns["hi"]})',
        'el': f'Griichesch ({ns["el"]})',
        'ko': f'Koreanesch ({ns["ko"]})',
        'pt': 'Portugisesch',
        'bn': f'Bengalesch ({ns["bn"]})',
        'pa': f'Punjabi ({ns["pa"]})',
        'fa': f'Persesch ({ns["fa"]})',
        'sw': 'Swahili',
        'so': 'Somali',
        ...
        'no': 'Norwegesch',
        'da': 'Dänesch',
        'tr': f'Tierkesch ({ns["tr"]})',
        'hu': 'Ungaresch',
        'new': f'Nepal Bhasa ({ns["new"]})',
        'bo': f'Lhasa Tibetesch ({ns["bo"]})',
        'si': f'Singhaleesesch ({ns["si"]})',
        'or': f'Odia ({ns["or"]})',
        'ta': f'Tamilesch ({ns["ta"]})',
        'hy': f'Armenesch ({ns["hy"]})',
        'tl': 'Tagalog',
        'ka': f'Georgesch ({ns["ka"]})',
        'am': f'Amharesch ({ns["am"]})',
        'kn': f'Kannada ({ns["kn"]})',
        'yo': 'Yoruba',
        'zu': 'IsiZulu',
        'ig': 'Igbo',
        ...
        'fi': 'Finnesch',
        'mn': 'Mongolesch (Latin)',
        'tt': f'Tataresch ({ns["tt"]})',
        'kk': f'Kasachesch ({ns["kk"]})',
        'ky': f'Kirgisesch ({ns["ky"]})',
        'cs': 'Tschechesch',
        'ro': 'Rumänesch',
        'ku': f'Kurdesch ({ns["ku"]})',
        'af': 'Afrikaans',
    ...
    t['ga'] = {
        ...
        'zh': f'Sínis ({ns["zh"]})',
        'he': f'Eabhrais ({ns["he"]})',
        'th': f'Téalainnis ({ns["th"]})',
        'vi': f'Vítneamais ({ns["vi"]})',
        'ar': f'Araibis ({ns["ar"]})',
        'hi': f'Hiondúis ({ns["hi"]})',
        'el': f'Gréigis ({ns["el"]})',
        'ko': f'Cóiréis ({ns["ko"]})',
        'pt': 'Portaingéilis',
        'bn': f'Beangáilis ({ns["bn"]})',
        'pa': f'Puinseáibis ({ns["pa"]})',
        'fa': f'Peirsis ({ns["fa"]})',
        'sw': 'Svahaílis',
        'so': 'Somáilis',
        'id': 'Indinéisis',
        ...
        'new': f'Nepal Bhasa ({ns["new"]})',
        'bo': f'Tibéidis ({ns["bo"]})',
        'si': f'Sinéalaís ({ns["si"]})',
        'or': f'Odia ({ns["or"]})',
        'ta': f'Tamilís ({ns["ta"]})',
        'hy': f'Airméinis ({ns["hy"]})',
        'tl': 'Tagalog',
        'ka': f'Seoirsis ({ns["ka"]})',
        'am': f'Amárais ({ns["am"]})',
        'kn': f'Cannadais ({ns["kn"]})',
        'yo': 'Yorúba',
        'zu': 'IsiZulu',
        'ig': 'Igbo',
        'gu': f'Gúisearáitis ({ns["gu"]})',
        'ha': 'Haúsa',
        'jv': 'Iávánais',
        'ur': f'Urdúis ({ns["ur"]})',
        'ps': f'Paistis ({ns["ps"]})',
        'te': f'Teileagúis ({ns["te"]})',
        'mr': f'Maraitis ({ns["mr"]})',
        'mg': 'Malagasais',
        'my': f'Burmais ({ns["my"]})',
        'bg': 'Bulgáiris',
        'ml': 'Mailéalaimis (മലയാളം)',
        'la': 'Laidin',
        'eu': 'Bascais',
        'fi': 'Fionlainnis',
        'mn': 'Mongóilís (Latin)',
    ...
    t['cy'] = {
        ...
        'hr': 'Croateg',
        'uk': f'Wcraineg ({ns["uk"]})',
        'zh': f'Tsieinëeg ({ns["zh"]})',
        'he': f'Hebraeg ({ns["he"]})',
        'th': f'Taieg ({ns["th"]})',
        'vi': f'Fietnameg ({ns["vi"]})',
        'ar': f'Arabeg ({ns["ar"]})',
        'hi': f'Hindi ({ns["hi"]})',
        'el': f'Groeg ({ns["el"]})',
        'ko': f'Coreeg ({ns["ko"]})',
